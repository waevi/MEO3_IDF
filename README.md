...
Thư viện MEO3 viết trên ESP-IDF với gốc là được viết bởi @lgthevinh [https://github.com/lgthevinh] trên PlatformIO với Arduino Framework và phiên bản dành cho ESP-IDF được viết bởi tôi.
